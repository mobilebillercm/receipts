...
use PhpAmqpLib\Connection\AMQPStreamConnection;
    ...
    $channel->exchange_declare(
        parse_ini_file("global-var-config.ini", true)['EXCHANGES']['RECEIPT_EMITTED_EXCHANGE'],
        'fanout',
        false,
        true,
        false);
    ...
    list($queue_name, ,) = $channel->queue_declare(
        parse_ini_file("global-var-config.ini", true)['QUEUES']['RECEIPT_RECEIPT_EMITTED_QUEUE'],
        false,
        true,
        false,
        false);
    ...
    $callback = function ($msg) {
        ...
        try {
            ...
            $tokenUrl = parse_ini_file("global-var-config.ini", true)['URLS']['HOST_RECEIPT'] . '/oauth/token';
        ...
        try {
            ...
            $url = parse_ini_file("global-var-config.ini", true)['URLS']['HOST_RECEIPT'] . '/api/receipts';
